...
# group has 46 free-form study labels (ex1, pilot2, shared...) — collapse to
# single-group vs multi-group ("shared*" = spans multiple study groups).
...
panel(cm_grp, "group (single vs multi)")
dev.off()
cat("wrote", out, "\n")
})
